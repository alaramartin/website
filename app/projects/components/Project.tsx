...
const Project = ({
    ...
    return (
        <div
            className={`${serif.className} antialiased border border-lightred bg-pinkbeige rounded-2xl p-4 shadow-lg/15 shadow-lightred relative h-full place-content-center`}
        >
